...
contract StarNotary is ERC721 {
    ...
    // Token name
    // string private _name = 'StarNotary';
    // Token symbol
    ...
    function createStar(string memory __name, uint256 _tokenId) public {
        // Passing the name and tokenId as a parameters
        Star memory newStar = Star(__name); // Star is an struct so we are creating a new Star
    ...
    function buyStar(uint256 _tokenId) public payable {
        ...
        // if (_isApprovedOrOwner(ownerAddress, _tokenId)) {
        ...
        //         // _transfer(ownerAddress, msg.sender, msg.value - starCost);
